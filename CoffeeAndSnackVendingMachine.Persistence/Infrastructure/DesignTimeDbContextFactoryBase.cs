...
namespace CoffeeAndSnackVendingMachine.Persistence.Infrastructure
{
    public abstract class DesignTimeDbContextFactoryBase<T> : IDesignTimeDbContextFactory<T> where T : DbContext
    {
        ...
        {
            var basePath = Directory.GetCurrentDirectory() + string.Format("{0}..{0}CoffeeAndSnackVendingMachine.API", Path.DirectorySeparatorChar);
